...
/**
 * Servlet implementation class GetOwnDeviceServlet
 */
@WebServlet("/GetOwnDeviceServlet")
public class GetOwnDeviceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetOwnDeviceServlet() {
        super();
			...
			while(rs.next())
			 {
			        ...
			        System.out.println(id+did+device_name+owner+isDisabled);
			 
				if(owner_id!=null) {
					
					 JsonObject jsonData = new JsonObject();
					    jsonData.addProperty("Device_id", id);
					    jsonData.addProperty("Device_id", did );
					    jsonData.addProperty("Device_name", device_name);
